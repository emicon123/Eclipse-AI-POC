...
import { PartType, ShipPart, Blueprint, TechTile } from '../types/index';
...
export const DISCOVERY_TILES = [
    ...
    { id: 'science_3', name: 'Ancient Data', type: 'RESOURCE', label: '+3 Science', description: 'Immediate resource grant.' },
    { id: 'materials_3', name: 'Ancient Ore', type: 'RESOURCE', label: '+3 Materials', description: 'Immediate resource grant.' },
    { id: 'ion_turret', name: 'Ion Turret', type: 'PART', label: 'Ion Turret', description: 'Ancient Ship Part: 2 Damage, 0 Power, 1 Initiative.' },
    { id: 'flux_missile', name: 'Flux Missile', type: 'PART', label: 'Flux Missile', description: 'Ancient Ship Part: 2 Damage, 0 Power, Initiative.' },
    { id: 'conifold_field', name: 'Conifold Field', type: 'PART', label: 'Conifold Field', description: 'Ancient Ship Part: 3 Hull.' },
    { id: 'shard_hull', name: 'Shard Hull', type: 'PART', label: 'Shard Hull', description: 'Ancient Ship Part: 1 Hull, -1 Weight.' },
    { id: 'hyper_grid', name: 'Hyper Grid', type: 'PART', label: 'Hyper Grid Source', description: 'Ancient Ship Part: 11 Power.' }
];

export const SHIP_PARTS: ShipPart[] = [
  // --- ANCIENT PARTS (Discovery) ---
  { id: 'ion_turret', name: 'Ion Turret', type: PartType.CANNON, cost: 0, damage: 2, computer: 0, shield: 0, hull: 0, initiative: 1, powerUsage: 0, powerGeneration: 0, color: 'text-yellow-500', isRare: true },
  { id: 'flux_missile', name: 'Flux Missile', type: PartType.MISSILE, cost: 0, damage: 2, computer: 0, shield: 0, hull: 0, initiative: 2, powerUsage: 0, powerGeneration: 0, color: 'text-orange-500', isRare: true },
  { id: 'conifold_field', name: 'Conifold Field', type: PartType.HULL, cost: 0, damage: 0, computer: 0, shield: 0, hull: 3, initiative: 0, powerUsage: 0, powerGeneration: 0, color: 'text-purple-400', isRare: true },
  { id: 'shard_hull', name: 'Shard Hull', type: PartType.HULL, cost: 0, damage: 0, computer: 0, shield: 0, hull: 1, initiative: 0, powerUsage: 0, powerGeneration: 0, color: 'text-cyan-300', isRare: true },
  { id: 'hyper_grid', name: 'Hyper Grid', type: PartType.SOURCE, cost: 0, damage: 0, computer: 0, shield: 0, hull: 0, initiative: 0, powerUsage: 0, powerGeneration: 11, color: 'text-pink-500', isRare: true },
  ...
  { id: 'plasma_cannon', name: 'Plasma Cannon', type: PartType.CANNON, cost: 0, damage: 2, computer: 0, shield: 0, hull: 0, initiative: 0, powerUsage: 2, powerGeneration: 0, color: 'text-orange-500', requiredTechId: 'plasma_cannon' },
  { id: 'soliton_cannon', name: 'Soliton Cannon', type: PartType.CANNON, cost: 0, damage: 3, computer: 0, shield: 0, hull: 0, initiative: 0, powerUsage: 3, powerGeneration: 0, color: 'text-red-500', requiredTechId: 'soliton_cannon_tech' },
  { id: 'antimatter_cannon', name: 'Antimatter Cannon', type: PartType.CANNON, cost: 0, damage: 4, computer: 0, shield: 0, hull: 0, initiative: 0, powerUsage: 4, powerGeneration: 0, color: 'text-red-600', requiredTechId: 'antimatter_cannon' },
  ...
  { id: 'positron_comp', name: 'Positron Computer', type: PartType.COMPUTER, cost: 0, damage: 0, computer: 2, shield: 0, hull: 0, initiative: 1, powerUsage: 1, powerGeneration: 0, color: 'text-blue-400', requiredTechId: 'positron_computer' },
  { id: 'gluon_comp', name: 'Gluon Computer', type: PartType.COMPUTER, cost: 0, damage: 0, computer: 3, shield: 0, hull: 0, initiative: 2, powerUsage: 2, powerGeneration: 0, color: 'text-blue-500', requiredTechId: 'gluon_computer' },
  ...
  { id: 'gauss_shield', name: 'Gauss Shield', type: PartType.SHIELD, cost: 0, damage: 0, computer: 0, shield: 1, hull: 0, initiative: 0, powerUsage: 0, powerGeneration: 0, color: 'text-cyan-400', requiredTechId: 'gauss_shield' },
  { id: 'phase_shield', name: 'Phase Shield', type: PartType.SHIELD, cost: 0, damage: 0, computer: 0, shield: 2, hull: 0, initiative: 0, powerUsage: 1, powerGeneration: 0, color: 'text-cyan-500', requiredTechId: 'phase_shield' },
  ...
  { id: 'fusion_drive', name: 'Fusion Drive', type: PartType.DRIVE, cost: 0, damage: 0, computer: 0, shield: 0, hull: 0, initiative: 2, powerUsage: 2, powerGeneration: 0, color: 'text-purple-400', requiredTechId: 'fusion_drive' },
  { id: 'tachyon_drive', name: 'Tachyon Drive', type: PartType.DRIVE, cost: 0, damage: 0, computer: 0, shield: 0, hull: 0, initiative: 3, powerUsage: 3, powerGeneration: 0, color: 'text-purple-500', requiredTechId: 'tachyon_drive' },
  ...
  { id: 'fusion_source', name: 'Fusion Source', type: PartType.SOURCE, cost: 0, damage: 0, computer: 0, shield: 0, hull: 0, initiative: 0, powerUsage: 0, powerGeneration: 6, color: 'text-orange-600', requiredTechId: 'fusion_source' },
  { id: 'tachyon_source', name: 'Tachyon Source', type: PartType.SOURCE, cost: 0, damage: 0, computer: 0, shield: 0, hull: 0, initiative: 0, powerUsage: 0, powerGeneration: 9, color: 'text-pink-600', requiredTechId: 'tachyon_source' },
  
  // Reinforced Hull
  { id: 'reinforced_hull', name: 'Reinforced Hull', type: PartType.HULL, cost: 0, damage: 0, computer: 0, shield: 0, hull: 2, initiative: 0, powerUsage: 0, powerGeneration: 0, color: 'text-green-500', requiredTechId: 'improved_hull' },
];
